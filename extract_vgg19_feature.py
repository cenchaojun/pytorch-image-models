...
if __name__ == '__main__':
    ...
    print(files_list)
    resnet50_feature_extractor = models.vgg19(num_classes=256)
    print(resnet50_feature_extractor)
    # resnet50_feature_extractor.fc = nn.Linear(2048, 1024)
    resnet50_feature_extractor.load_state_dict(torch.load('best_vgg19.pth', map_location='cuda:0'))
    resnet50_feature_extractor.fc = nn.Linear(4096, 4096)
    ...
    df.to_csv('feature_vgg19_4096.csv',index=False)